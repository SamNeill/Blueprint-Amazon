...
class HomeFragment : Fragment(R.layout.fragment_home), HomeItemsListener {
    ...
    private val wallpaper: Drawable?
        get() = activity?.let {
            ColorDrawable(it.resolveColor(MaterialR.attr.colorBackgroundFloating))
        }
    ...
    public fun showDonation(show: Boolean) {
    ...
    override fun onShareClicked() {
        try {
            ...
            val intent = Intent(Intent.ACTION_SEND).apply {
                ...
                putExtra(
                    Intent.EXTRA_TEXT,
                    "Check out ${context?.getAppName()} on Amazon Store: https://www.amazon.com/dp/$asin"
                )
            }
